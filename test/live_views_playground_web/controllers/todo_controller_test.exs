defmodule LiveViewsPlaygroundWeb.TodoControllerTest do
  use LiveViewsPlaygroundWeb.ConnCase

  import LiveViewsPlayground.TodosFixtures

  @create_attrs %{description: "some description", completed: true}
